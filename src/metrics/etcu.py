...
def compute_etcu(confidences: np.ndarray, labels: np.ndarray, threshold: float) -> float:
    """
...
def compute_etcu_auc(confidences: np.ndarray, labels: np.ndarray, granularity: int = 999) -> float:
    """
...
def compute_all_etcu_metrics(confidences: np.ndarray, labels: np.ndarray) -> dict[str, float]:
    """
